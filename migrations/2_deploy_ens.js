...
const OldBaseRegistrar = artifacts.require("BaseRegistrarImplementation");
...
module.exports = async function(deployer, network, accounts) {
  ...
  await deployer.deploy(OldBaseRegistrar, ens.address, hashRegistrar.address, ETH_NODE, {from: accounts[0]});
